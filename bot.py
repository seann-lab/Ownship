...
async def _ip_check_one_strict_async(proxy_url: str, timeout: int = 15, settings: dict = None) -> dict:
    ...
    # FIXED: Changed 'proxies' to 'proxy' for httpx compatibility!
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                if data.get("status") == "success":
                    ...
                    clean_isps = ["vivo", "claro", "tim", "telemar", "telefonica", "braspd", "as26599", "oi móvel", "algar", "net serviços"]
                    is_clean_provider = any(net in full_isp_info for net in clean_isps)
                    ...
                    score = 98 if is_clean_provider else 85
                    ...
                    return {
                        ...
                        "isp": isp or org,
                        "privacy": "FALSE (Clean Residential)",
                        "score": score
                    }
        except Exception as e:
